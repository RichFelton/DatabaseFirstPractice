...
namespace DatabaseFirstPractice.Models
{
    public class DatabaseFirstPracticeContext : DbContext
    {
        ...
        public System.Data.Entity.DbSet<DatabaseFirstPractice.Models.Movie> Movies { get; set; }

        public System.Data.Entity.DbSet<DatabaseFirstPractice.Models.Rental> Rentals { get; set; }
    }
}

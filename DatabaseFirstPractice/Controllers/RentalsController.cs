...
namespace DatabaseFirstPractice.Controllers
{
    public class RentalsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "RentalID,RentalDate,MovieID,CustomerID")] Rental rental)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "RentalID,RentalDate,MovieID,CustomerID")] Rental rental)
        {
            if (ModelState.IsValid)
            {
